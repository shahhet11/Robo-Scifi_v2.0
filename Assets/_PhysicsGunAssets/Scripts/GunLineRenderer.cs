...
public class GunLineRenderer : MonoBehaviour
{
    ...
    [Header("PhysGunInitiate Sound"), Space(5)]
    [SerializeField]
    private AudioSource PhysGunSound;
    [SerializeField]
    private AudioClip[] PhysGunSoundStream;
    bool clipchange;
    ...
    private void LateUpdate()
    {
        ...
        {
            PhysGunSound.clip = PhysGunSoundStream[0];
            PhysGunSound.Play();
        }
        else if (Input.GetMouseButtonUp(1))
        {

            PhysGunSound.clip = PhysGunSoundStream[1];
            PhysGunSound.Play();
        }
